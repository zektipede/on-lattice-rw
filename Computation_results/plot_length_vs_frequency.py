...
file_path_branched = os.path.join(folder_path, f'lengths_branched_cables_100r_{lattice}_{l}by{l}by{l}_{num_neurons_in_sim}n.txt')
file_path_terminated = os.path.join(folder_path, f'lengths_terminated_cables_100r_{lattice}_{l}by{l}by{l}_{num_neurons_in_sim}n.txt')
Number_of_sims = 100 #will be 100
...
counts_b_norm = [count / Number_of_sims for count in counts_b]
counts_t_norm = [count / Number_of_sims  for count in counts_t]
sum_counts_norm = [count / Number_of_sims  for count in sum_counts]
